...
var Button = function (_DataComponent) {
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      var body = void 0;
      if (this.props.icon) {
        body = this.renderIcon();
      } else {
        if (this.props.isSafeHtml) {
          body = _react2.default.createElement('span', { dangerouslySetInnerHTML: { __html: this.props.children } });
        } else {
